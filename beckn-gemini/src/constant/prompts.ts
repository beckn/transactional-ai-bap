  ...
  aiDetectGreeting: [
    {
      ...
      parts: [
        {
          text: "Identify whether the provided message is a greeting message or not. If the message contains only Yes then return 'false'"
        }
      ]
    },
    {
